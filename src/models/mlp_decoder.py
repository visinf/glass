...
class MlpDecoder(nn.Module):
    ...
    def __init__(self, object_dim, output_dim, num_patches, hidden_features = 2048, decoder_type=None):
        super().__init__()
    ...
    def forward(self, encoder_output):
        ...
        object_features = encoder_output + self.pos_embed.to(encoder_output.device)
